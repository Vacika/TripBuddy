...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) =>
      Scaffold(appBar: AppBar(title: Text("Home Screen")), body: new TripCard(trip: tripListResponse)
          // body: Center(
          //   child: FutureBuilder(
          //       future: HttpService()
